Description of supplementary data for Edmonsond et al. (in review): "Shallow carbonate geochemistry in the Bahamas since the last interglacial period"

Laboratory methods are described in the main text and supplementary material of Edmonsond et al. (in review). Supplementary data are provided in .csv files:
...
Summary geochemical data (d13C, d18O, mineralogy, d44Ca, and elemental concentrations relative to Ca and Mg), radiocarbon ages, and MCMC age estimates for each sample. Data for each sediment core is provided in a separate .csv file. 
